    ...
    <section className="contact-section">
      ...
      <div className="contactForm">
        <form className="contact-form" action="#">
          ...
          <input
            type="submit"
            className="input submit bg-primary"
            value="Send Message"
          />
        </form>
        ...
        <div className="flex flex-col my-8">
          <div>
          <div className="method p-2 flex mt-2 bg-white">
            <div className="mx-4 flex items-center">
              <ImLocation size={24} />
            </div>
            <article className="text-left">
              <h1 className="sub-heading text-sm">Location</h1>
              <p className="text-sm">Varkala</p>
            </article>
          </div>
          ...
          <div className="method p-2 flex mt-2 bg-white">
            ...
            <article className="text-left">
              <h1 className="sub-heading text-sm">Email</h1>
              <p className="text-sm">alwinaswin123@gmail.com</p>
            </article>
          </div>

          <div className="method p-2 flex mt-2 mb-4 bg-white">
            <div className="mx-4 flex items-center">
              <BsFillTelephoneForwardFill size={24} />
            </div>
            <article className="text-left">
              <h1 className="sub-heading text-sm">Phone</h1>
              <p className="text-sm">+91 9746564270 </p>
            </article>
          </div>
          </div>
